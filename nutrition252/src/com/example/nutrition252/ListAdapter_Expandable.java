...
public class ListAdapter_Expandable extends BaseExpandableListAdapter {
	...
	public ListAdapter_Expandable(Context context, List<String> listDataHeader,
	...
	public Object getChild(int groupPosition, int childPosititon) {
		return this.getListChildData.get(
				this.getListHeaderData.get(groupPosition)).get(childPosititon);
	}
	...
	public int getChildrenCount(int groupPosition) {
		return this.getListChildData.get(
				this.getListHeaderData.get(groupPosition)).size();
	}
